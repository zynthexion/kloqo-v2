...
export function DateOverrideManager({ doctor, onUpdate, mode = 'full' }: DateOverrideManagerProps) {
      ...
      <CardHeader className="p-8 border-b border-slate-50 bg-slate-50/50">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <CardDescription className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Manage one-off schedule changes {mode === 'full' && "and vacations"}</CardDescription>
          </div>
        </div>
      </CardHeader>
