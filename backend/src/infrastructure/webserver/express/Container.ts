...
const cancelBreakUseCase = new CancelBreakUseCase(appointmentRepo, doctorRepo, clinicRepo, activityRepo, queueBubblingService, notificationService);
...
const createWalkInAppointmentUseCase = new CreateWalkInAppointmentUseCase(appointmentRepo, doctorRepo, clinicRepo, managePatientUseCase, tokenGeneratorService, sseService, notificationService);
const bookAdvancedAppointmentUseCase = new BookAdvancedAppointmentUseCase(appointmentRepo, doctorRepo, patientRepo, clinicRepo, managePatientUseCase, tokenGeneratorService, tokenStrategyFactory, sseService, notificationService);
